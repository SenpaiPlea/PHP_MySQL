...
// $sth: Like a notepad that holds our prepared SQL statement
// $conn: Our direct line to the database
// $db: Our connection to the database butler (Db_conn)
// $error: A flag that tells us if something went wrong
